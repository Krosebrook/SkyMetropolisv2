...
const ProceduralBuilding = React.memo(({ type, baseColor, x, y, opacity = 1, transparent = false }: BuildingMeshProps) => {
  ...
  const metalMat = useMemo(() => new THREE.MeshStandardMaterial({ color: '#9ca3af', roughness: 0.4, metalness: 0.6 }), []);
        ...
        switch (type) {
            ...
            if (variant < 20) {
              ...
              return (
                <>
                  ...
                  <mesh {...commonProps} material={accentMat} geometry={boxGeo} position={[0, 0.1, 0.31]} scale={[0.2, 0.4, 0.05]} />
                </>
              );
            } else if (variant < 80) {
              // Apartment Block
              return (
                <>
                  <mesh {...commonProps} material={mainMat} geometry={boxGeo} position={[0, 0.6, 0]} scale={[0.8, 1.2, 0.7]} />
                  <mesh {...commonProps} material={roofMat} geometry={boxGeo} position={[0, 1.25, 0]} scale={[0.7, 0.1, 0.6]} />
                  <WindowBlock position={[-0.2, 0.9, 0.36]} scale={[0.2, 0.2, 0.05]} />
                  <WindowBlock position={[0.2, 0.9, 0.36]} scale={[0.2, 0.2, 0.05]} />
                  <WindowBlock position={[-0.2, 0.5, 0.36]} scale={[0.2, 0.2, 0.05]} />
                  <WindowBlock position={[0.2, 0.5, 0.36]} scale={[0.2, 0.2, 0.05]} />
                  <mesh {...commonProps} material={accentMat} geometry={boxGeo} position={[0, 0.15, 0.36]} scale={[0.3, 0.3, 0.05]} />
                </>
              );
            } else {
              // Mansion
              return (
                <>
                  <mesh {...commonProps} material={mainMat} geometry={boxGeo} position={[-0.1, 0.4, 0]} scale={[0.6, 0.8, 0.6]} />
                  <mesh {...commonProps} material={mainMat} geometry={boxGeo} position={[0.3, 0.3, 0.1]} scale={[0.4, 0.6, 0.5]} />
                  <mesh {...commonProps} material={roofMat} geometry={coneGeo} position={[-0.1, 0.95, 0]} scale={[0.5, 0.4, 0.5]} rotation={[0, Math.PI/4, 0]} />
                  <mesh {...commonProps} material={roofMat} geometry={boxGeo} position={[0.3, 0.65, 0.1]} scale={[0.45, 0.1, 0.55]} />
                  <WindowBlock position={[-0.1, 0.5, 0.31]} scale={[0.3, 0.2, 0.05]} />
                  <mesh {...commonProps} material={accentMat} geometry={boxGeo} position={[0.3, 0.2, 0.36]} scale={[0.2, 0.4, 0.05]} />
                </>
              );
            }
          ...
          case BuildingType.Commercial:
            ...
            if (variant < 25) {
              ...
              return (
                <>
                  ...
                  {Array.from({ length: Math.floor(height * 2.5) }).map((_, i) => (
                    <WindowBlock key={i} position={[0, 0.2 + i * 0.4, 0]} scale={[0.72, 0.25, 0.72]} />
                  ))}
              ...
              return (
                <>
                   <mesh {...commonProps} material={mainMat} geometry={boxGeo} position={[-0.2, 0.7, 0]} scale={[0.35, 1.4, 0.4]} />
                   <mesh {...commonProps} material={mainMat} geometry={boxGeo} position={[0.2, 0.5, 0]} scale={[0.35, 1.0, 0.4]} />
                   <mesh {...commonProps} material={accentMat} geometry={boxGeo} position={[0, 0.2, 0]} scale={[0.8, 0.4, 0.6]} />
                   <WindowBlock position={[-0.2, 0.8, 0.21]} scale={[0.25, 1.0, 0.05]} />
                   <WindowBlock position={[0.2, 0.6, 0.21]} scale={[0.25, 0.6, 0.05]} />
                </>
              );
            }
            ...
            if (variant < 40) {
              ...
              return (
                <>
                  ...
                  <mesh {...commonProps} material={metalMat} geometry={boxGeo} position={[0.25, 0.7, 0]} scale={[0.05, 0.05, 0.5]} />
                </>
              );
            } else {
              // Storage Tanks
              return (
                <>
                   <mesh {...commonProps} material={accentMat} geometry={boxGeo} position={[0, 0.1, 0]} scale={[0.9, 0.2, 0.9]} />
                   <mesh {...commonProps} material={mainMat} geometry={cylinderGeo} position={[-0.2, 0.5, -0.2]} scale={[0.25, 0.8, 0.25]} />
                   <mesh {...commonProps} material={mainMat} geometry={cylinderGeo} position={[0.2, 0.5, 0.2]} scale={[0.25, 0.8, 0.25]} />
                   <mesh {...commonProps} material={metalMat} geometry={cylinderGeo} position={[-0.2, 0.5, -0.2]} scale={[0.26, 0.1, 0.26]} />
                   <mesh {...commonProps} material={metalMat} geometry={cylinderGeo} position={[0.2, 0.5, 0.2]} scale={[0.26, 0.1, 0.26]} />
                   {/* Pipe */}
                   <mesh {...commonProps} material={metalMat} geometry={boxGeo} position={[0, 0.7, 0]} scale={[0.6, 0.05, 0.05]} rotation={[0, Math.PI/4, 0]} />
                </>
              );
            }
          ...
          case BuildingType.Park:
            ...
            // Base Park Plane to ensure no grass fighting
            const ParkBase = () => (
            ...
            return (
              <group position={[0, -yOffset - 0.29, 0]}> {/* Adjust park base to sit exactly on top of ground tile */}
                ...
                {variant < 40 ? (
                  ...
                  // Fountain Park
                  <group>
                     <mesh castShadow receiveShadow material={new THREE.MeshStandardMaterial({ color: '#cbd5e1' })} geometry={cylinderGeo} position={[0, 0.1, 0]} scale={[0.6, 0.2, 0.6]} />
                     <mesh castShadow receiveShadow material={new THREE.MeshStandardMaterial({ color: '#3b82f6', opacity: 0.8, transparent: true })} geometry={cylinderGeo} position={[0, 0.15, 0]} scale={[0.5, 0.15, 0.5]} />
                     <mesh castShadow receiveShadow material={new THREE.MeshStandardMaterial({ color: '#cbd5e1' })} geometry={cylinderGeo} position={[0, 0.4, 0]} scale={[0.1, 0.6, 0.1]} />
                     <mesh castShadow receiveShadow material={new THREE.MeshStandardMaterial({ color: '#60a5fa' })} geometry={sphereGeo} position={[0, 0.7, 0]} scale={0.15} />
                     {/* Benches */}
                     <mesh castShadow receiveShadow material={new THREE.MeshStandardMaterial({ color: '#78350f' })} geometry={boxGeo} position={[0.35, 0.1, 0]} scale={[0.1, 0.1, 0.3]} />
                     <mesh castShadow receiveShadow material={new THREE.MeshStandardMaterial({ color: '#78350f' })} geometry={boxGeo} position={[-0.35, 0.1, 0]} scale={[0.1, 0.1, 0.3]} />
                  </group>
                ) : (
                  // Playground Park
                  <group>
                     {/* Sandpit */}
                     <mesh receiveShadow position={[0.2, 0.02, 0.2]} rotation={[-Math.PI/2,0,0]}>
                        <circleGeometry args={[0.25, 16]} />
                        <meshStandardMaterial color="#fcd34d" />
                     </mesh>
                     {/* Swing frame */}
                     <mesh castShadow receiveShadow material={metalMat} geometry={boxGeo} position={[-0.2, 0.3, -0.2]} scale={[0.05, 0.6, 0.05]} rotation={[0,0,0.2]} />
                     <mesh castShadow receiveShadow material={metalMat} geometry={boxGeo} position={[0.1, 0.3, -0.2]} scale={[0.05, 0.6, 0.05]} rotation={[0,0,-0.2]} />
                     <mesh castShadow receiveShadow material={metalMat} geometry={boxGeo} position={[-0.05, 0.6, -0.2]} scale={[0.4, 0.05, 0.05]} />
                     {/* Slide */}
                     <mesh castShadow receiveShadow material={new THREE.MeshStandardMaterial({ color: '#ef4444' })} geometry={boxGeo} position={[-0.2, 0.2, 0.2]} scale={[0.1, 0.4, 0.5]} rotation={[0.5, 0, 0]} />
                  </group>
                )}
              </group>
            );
...
const RoadMarkings = React.memo(({ x, y, grid, yOffset }: { x: number; y: number; grid: Grid; yOffset: number }) => {
  ...
  // Geometries
  const fullLineGeo = useMemo(() => new THREE.PlaneGeometry(0.12, 1), []);
  const halfLineGeo = useMemo(() => new THREE.PlaneGeometry(0.12, 0.5), []);
  const shortArmGeo = useMemo(() => new THREE.PlaneGeometry(0.12, 0.35), []); // Leaves gap for intersection
  const cornerGeo = useMemo(() => new THREE.RingGeometry(0.44, 0.56, 32, 1, 0, Math.PI / 2), []);
  const dotGeo = useMemo(() => new THREE.CircleGeometry(0.12, 12), []);
  ...
  const neighbors = [hasUp, hasDown, hasLeft, hasRight].filter(Boolean).length;
  ...
  if (neighbors === 0) {
      return (
        <group {...groupProps}>
            <mesh geometry={dotGeo} material={lineMaterial} />
        </group>
      );
  }

  // 2. Straight Roads
  if (neighbors === 2 && ((hasUp && hasDown) || (hasLeft && hasRight))) {
      return (
        <group {...groupProps}>
             <mesh geometry={fullLineGeo} material={lineMaterial} rotation={[0, 0, (hasLeft && hasRight) ? Math.PI / 2 : 0]} />
        </group>
      );
  }
  ...
  if (neighbors === 2) {
      ...
      return (
        <group {...groupProps}>
             <mesh geometry={cornerGeo} material={lineMaterial} position={position} rotation={[0, 0, rotation]} />
        </group>
      );
  }
  ...
  if (neighbors === 3) {
       ...
       return (
         <group {...groupProps}>
            {isVertical && <mesh geometry={fullLineGeo} material={lineMaterial} />}
            {isHorizontal && <mesh geometry={fullLineGeo} material={lineMaterial} rotation={[0,0,Math.PI/2]} />}
            
            {!isVertical && hasUp && <mesh geometry={shortArmGeo} material={lineMaterial} position={[0, 0.325, 0]} />}
            {!isVertical && hasDown && <mesh geometry={shortArmGeo} material={lineMaterial} position={[0, -0.325, 0]} />}
            {!isHorizontal && hasLeft && <mesh geometry={shortArmGeo} material={lineMaterial} position={[-0.325, 0, 0]} rotation={[0,0,Math.PI/2]} />}
            {!isHorizontal && hasRight && <mesh geometry={shortArmGeo} material={lineMaterial} position={[0.325, 0, 0]} rotation={[0,0,Math.PI/2]} />}
         </group>
       );
  }
  ...
  return (
    <group {...groupProps}>
       {neighbors === 4 && (
           <>
               <mesh geometry={shortArmGeo} material={lineMaterial} position={[0, 0.325, 0]} />
               <mesh geometry={shortArmGeo} material={lineMaterial} position={[0, -0.325, 0]} />
               <mesh geometry={shortArmGeo} material={lineMaterial} position={[-0.325, 0, 0]} rotation={[0,0,Math.PI/2]} />
               <mesh geometry={shortArmGeo} material={lineMaterial} position={[0.325, 0, 0]} rotation={[0,0,Math.PI/2]} />
           </>
       )}
       ...
       {neighbors === 1 && (
           <>
              {hasUp && <mesh geometry={halfLineGeo} material={lineMaterial} position={[0, 0.25, 0]} />}
              {hasDown && <mesh geometry={halfLineGeo} material={lineMaterial} position={[0, -0.25, 0]} />}
              {hasLeft && <mesh geometry={halfLineGeo} material={lineMaterial} position={[-0.25, 0, 0]} rotation={[0,0,Math.PI/2]} />}
              {hasRight && <mesh geometry={halfLineGeo} material={lineMaterial} position={[0.25, 0, 0]} rotation={[0,0,Math.PI/2]} />}
              <mesh geometry={dotGeo} material={lineMaterial} />
           </>
       )}
    </group>
  ...
  return (
    <div className="absolute inset-0 bg-sky-900 touch-none">
      <Canvas shadows dpr={[1, 1.5]} gl={{ antialias: true }}>
        ...
        {/* SoftShadows removed due to shader incompatibility with newer Three.js versions */}
      </Canvas>
    </div>
  );
};
