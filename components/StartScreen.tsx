...
const StartScreen: React.FC<StartScreenProps> = ({ onStart }) => {
  ...
  return (
    <div className="absolute inset-0 flex flex-col items-center justify-center z-50 text-white font-sans p-6 bg-black/50 backdrop-blur-md">
      <div className="max-w-md w-full bg-slate-900/95 p-8 rounded-2xl border border-slate-700 shadow-2xl backdrop-blur-xl relative overflow-hidden">
        {/* Glow Effects */}
        ...
        <div className="relative z-10">
            ...
            <label className="flex items-center justify-between cursor-pointer group">
                ...
                <span className="text-xs text-slate-500 group-hover:text-slate-400 transition-colors">
                    Dynamic missions via Gemini API
                </span>
                </div>
