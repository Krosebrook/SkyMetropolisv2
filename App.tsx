...
const SFX = {
  place: new Howl({
    src: ['https://assets.mixkit.co/active_storage/sfx/2578/2578-preview.mp3'], // Pop
    volume: 0.5,
  }),
  bulldoze: new Howl({
    src: ['https://assets.mixkit.co/active_storage/sfx/2572/2572-preview.mp3'], // Heavy thud
    volume: 0.4,
  }),
  reward: new Howl({
    src: ['https://assets.mixkit.co/active_storage/sfx/2019/2019-preview.mp3'], // Chime/Win
    volume: 0.5,
  }),
  error: new Howl({
    src: ['https://assets.mixkit.co/active_storage/sfx/2573/2573-preview.mp3'], // Camera shutter/error-like click
    volume: 0.3,
  }),
};
